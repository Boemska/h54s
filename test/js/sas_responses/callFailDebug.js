...
_htcook = bd8d0d9f5d145f2f350149bf5189aede_Cluster=4404C39EE1C16DC13F7FA4F55BA55B0B.bd8d0d9f5d145f2f350149bf5189aede_SASServer1_1
...
data = [{"colName":"libname","colType":"string","colLength":4},{"colName":"memname","colType":"string","colLength":9}]
       [{"libname":"WORK","memname":"CHOSENLIB"}]
</pre>
﻿--h54s-data-start--
{
"outputdata" : [],
...
<hr /><h2>SAS Log</h2>
<pre>1                                                                                                                        The SAS System                                                                                            04:42 Tuesday, April 25, 2017
...
&gt;&gt;&gt; SAS Macro Variables:
 ...
 _METAUSER=jimdemo
 _PROGRAM=/AJAX/h54s_test/getData
 _REPLAY="&amp;_URL?_sessionid=854EC8E5-1590-3E49-ACDC-E9B62CD3D1E6&amp;_program=replay&amp;_entry=&amp;_TMPCAT.."
 _REQENCODING=UTF-8
 _REQMETH=POST
 _RESULT=STREAM
 _RMTADDR=0:0:0:0:0:0:0:1
...
<font color=blue>      cpu time            0.03 seconds
...
NOTE: The file _WEBOUT is:
      UUID=BF0251C4-6780-BA43-BEFF-115C08241813,
      HTTP:Content-type=text/html;charset=utf-8
</font>                                                                                          The SAS System

<font color=blue>
NOTE: 2 records were written to the file _WEBOUT.
...
NOTE: 9 records were written to the file _WEBOUT.
...
This request took 0.47 seconds of real time.
</div>
</body></html>
`
