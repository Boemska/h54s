...
`jsonvarname` is  the name given to the table array from the front end, coresponding to macroName in the `h54s.Tables(tableArray, macroName)` example 
